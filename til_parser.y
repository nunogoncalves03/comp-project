...
program : tBEGIN list tEND { compiler->ast(new til::function_node(LINE, new cdk::sequence_node(LINE), new cdk::sequence_node(LINE))); }
        ; /* FIXME */
...
stmt : expr ';'                         { $$ = new til::evaluation_node(LINE, $1); }
     ...
     | tREAD lval ';'                   { $$ = new til::read_node(LINE); }
