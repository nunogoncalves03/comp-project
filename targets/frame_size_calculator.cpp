...
void til::frame_size_calculator::do_null_pointer_node(til::null_pointer_node *const node, int lvl) {
  // EMPTY
}
void til::frame_size_calculator::do_return_node(til::return_node *const node, int lvl) {
  // EMPTY
}
void til::frame_size_calculator::do_allocation_node(til::allocation_node *const node, int lvl) {
  // EMPTY
}
